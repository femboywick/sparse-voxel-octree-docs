...
tags:
  - diataxis/background
---
The goal of this library is to navigate in a [[01 the Initial Problem#^volumetric-navigation|fully 3D way]], around obstacles and without requiring a floor like a navmesh does. It presents a sparse voxel octree, where a leaf node describes traverse-able space.
This SVO is then used with godot's A\* algorithm. 
