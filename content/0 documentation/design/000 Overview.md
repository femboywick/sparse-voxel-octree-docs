...
- Question: What's a "Sparse Voxel Octree"?
	- Answer: see [[01 Sparse Voxel Octrees - an Introduction]]
- Question: What's the point of an SVO? Why not just use a navmesh?
	- Answer: see [[00 the Initial Problem]]
- Question: How is this applied?
	- Answer: if you're looking for *cognition*, that is to say to *understand* how to make and use an SVO, see the three parts: todo: link
	- Answer: if you're looking for a *tutorial* on how to make your own SVO, see [[20 let's create - a sparse voxel octree in rust]]


---

This section is mainly concerned with [[01 Sparse Voxel Octrees - an Introduction|SVO]]s, constructing them, converting an initial SVO into a use-able traverse-able 3D navigation graph, and finally path-finding through the graph.
## [[00 the Initial Problem]]
![[00 the Initial Problem#^description]] 
...
## [[04 Path-Finding Through an SVO]]
