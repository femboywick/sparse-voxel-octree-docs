...
For an SVO, a voxel grid is constructed at the resolution of the lowest layer of the octree (IE highest resolution). From this intermediary, we can build a sparse octree from the bottom up.
